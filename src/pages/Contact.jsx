                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    { icon: 'call', title: 'Phone Numbers', detail: '8507020492 · 7033866582' },
                            ...
                            {/* WhatsApp CTA */}
                            <a
                                href="https://wa.me/918507020492"
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-xl font-bold text-lg transition-all shadow-lg"
                            >
                        ...
                        <div className="bg-background-light rounded-3xl p-8 border border-slate-100 shadow-md">
                            {submitted ? (
                                <div className="h-full flex flex-col items-center justify-center text-center py-12">
                                    ...
                                    <p className="text-slate-600">Thank you for reaching out. We'll contact you within 24 hours to discuss your child's enrollment.</p>
                                </div>
                            ) : (
                                <>
                                    <h3 className="text-2xl font-bold text-deep-blue mb-6">Book a Free Demo / Enquire Now</h3>
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <button
                                            type="submit"
                                            className="w-full bg-primary hover:bg-primary-hover text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg text-lg"
                                        >
                                            Submit Enquiry
                                        </button>
                                    </form>
            ...
            <section className="h-72 bg-slate-200 relative overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <p className="font-bold text-slate-500 mt-2">Bahuara More Deo, Bypass Road, Aurangabad, Bihar</p>
                        <a
                            href="https://maps.google.com/?q=Bahuara+More+Deo+Bypass+Road+Aurangabad+Bihar"
                            target="_blank"
                            rel="noreferrer"
                            className="mt-3 inline-block bg-primary text-white px-6 py-2 rounded-lg font-semibold text-sm hover:bg-primary-hover transition-all"
                        >
                            Open in Google Maps →
                        </a>
                    </div>
