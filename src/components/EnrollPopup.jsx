...
export default function EnrollPopup({ onClose }) {
    ...
    return (
        ...
        >
            ...
            >
                {/* Purple top bar */}
                <div className="h-2 w-full" style={{ background: 'linear-gradient(90deg, #4f0fa8 0%, #7c3aed 100%)' }}></div>

                {/* Close button */}
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 text-slate-400 hover:text-slate-700 transition-colors text-xl font-light leading-none"
                    aria-label="Close"
                >
                    âœ•
                </button>
                ...
                <div className="px-8 pb-8 pt-6">
                    {submitted ? (
                        <div className="text-center py-8">
                            ...
                            <p className="text-slate-500 text-sm mb-6">We will call you back shortly to confirm your free demo class.</p>
                        ...
                        <>
                            ...
                            <div className="text-center mb-6">
                                <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: '#ede9fe' }}>
                                    <span className="material-symbols-outlined text-3xl" style={{ color: '#5b21b6' }}>menu_book</span>
                                </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    className="w-full py-3.5 rounded-xl text-white font-bold text-base flex items-center justify-center gap-2 transition-all hover:opacity-90 shadow-lg mt-2"
                                    style={{ background: 'linear-gradient(90deg, #4f0fa8 0%, #7c3aed 100%)' }}
                                >
                                    Submit Inquiry
                                ...
                                {/* WhatsApp */}
                                <a
                                    href="https://wa.me/918507020492?text=Hi%2C%20I%20want%20to%20book%20a%20free%20demo%20class%20at%20The%20Sanskriti%20Academy"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="w-full py-3.5 rounded-xl text-white font-bold text-base flex items-center justify-center gap-2 transition-all hover:opacity-90"
                            ...
                            <div className="mt-5 text-center">
                                <div className="flex items-center justify-center gap-1 mb-2">
                                    <span className="material-symbols-outlined text-sm" style={{ color: '#5b21b6' }}>group</span>
                                    <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#5b21b6' }}>Call Now For Details</span>
                                </div>
                                <div className="flex justify-center gap-6">
                                    <a href="tel:8507020492" className="font-bold text-slate-800 text-base hover:text-purple-700 transition-colors">8507020492</a>
                                    <a href="tel:7033866582" className="font-bold text-slate-800 text-base hover:text-purple-700 transition-colors">7033866582</a>
                                </div>
                            </div>
                        </>
                    )}
